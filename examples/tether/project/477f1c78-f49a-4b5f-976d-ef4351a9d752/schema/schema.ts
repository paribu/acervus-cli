...
export namespace schema {
  export class IssueEventSchema extends filter.IssueEventSchemaFilter {
    ...
    static query(filters: filter.IssueEventSchemaFilter[]): IssueEventSchema[] {
      ...
      const dataList = (<JSON.Arr>JSON.parse(stringifiedRes)).valueOf();
    ...
    static stringifyFilters(filters: filter.IssueEventSchemaFilter[]): string {
      ...
      for (let i = 0; i < filters.length; i++) {
        ...
        if (filter.IsSet$Id) jsonObj.set("$id", filter.$Id);
  ...
  export class RedeemEventSchema extends filter.RedeemEventSchemaFilter {
    ...
    static query(
      filters: filter.RedeemEventSchemaFilter[],
    ): RedeemEventSchema[] {
      const stringifiedRes = queryFromDb(
        "RedeemEventSchema",
  ...
  export class DeprecateEventSchema extends filter.DeprecateEventSchemaFilter {
    ...
    static query(
      filters: filter.DeprecateEventSchemaFilter[],
    ...
    static stringifyFilters(
      ...
      for (let i = 0; i < filters.length; i++) {
        ...
        if (filter.IsSetNewAddress)
          jsonObj.set("newAddress", filter.NewAddress);
  ...
  export class ParamsEventSchema extends filter.ParamsEventSchemaFilter {
    ...
    static query(
      filters: filter.ParamsEventSchemaFilter[],
    ): ParamsEventSchema[] {
      const stringifiedRes = queryFromDb(
        "ParamsEventSchema",
      ...
      for (let i = 0; i < dataList.length; i++) {
        ...
        if (feeBasisPoints != null)
          res[i].FeeBasisPoints = BigInt.from(feeBasisPoints.valueOf());
    ...
    static stringifyFilters(filters: filter.ParamsEventSchemaFilter[]): string {
      ...
      for (let i = 0; i < filters.length; i++) {
        ...
        if (filter.IsSetFeeBasisPoints)
          jsonObj.set("feeBasisPoints", filter.FeeBasisPoints);
  ...
  export class DestroyedBlackFundsEventSchema extends filter.DestroyedBlackFundsEventSchemaFilter {
    ...
    static query(
      filters: filter.DestroyedBlackFundsEventSchemaFilter[],
      ...
      for (let i = 0; i < dataList.length; i++) {
        ...
        if (_blackListedUser != null)
          res[i].BlackListedUser = _blackListedUser.valueOf();
    ...
    static stringifyFilters(
      ...
      for (let i = 0; i < filters.length; i++) {
        ...
        if (filter.IsSetBlackListedUser)
          jsonObj.set("_blackListedUser", filter.BlackListedUser);
  ...
  export class AddedBlackListEventSchema extends filter.AddedBlackListEventSchemaFilter {
    ...
    static query(
      filters: filter.AddedBlackListEventSchemaFilter[],
  ...
  export class RemovedBlackListEventSchema extends filter.RemovedBlackListEventSchemaFilter {
    ...
    static query(
      filters: filter.RemovedBlackListEventSchemaFilter[],
  ...
  export class ApprovalEventSchema extends filter.ApprovalEventSchemaFilter {
    ...
    static query(
      filters: filter.ApprovalEventSchemaFilter[],
    ): ApprovalEventSchema[] {
      const stringifiedRes = queryFromDb(
        "ApprovalEventSchema",
  ...
  export class TransferEventSchema extends filter.TransferEventSchemaFilter {
    ...
    static query(
      filters: filter.TransferEventSchemaFilter[],
    ): TransferEventSchema[] {
      const stringifiedRes = queryFromDb(
        "TransferEventSchema",
  ...
  export class UnpauseEventSchema extends filter.UnpauseEventSchemaFilter {
    ...
    static query(
      filters: filter.UnpauseEventSchemaFilter[],
    ): UnpauseEventSchema[] {
      const stringifiedRes = queryFromDb(
        "UnpauseEventSchema",
